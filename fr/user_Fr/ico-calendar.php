...
<html lang="en">
	...
	<body>
		<nav>
			...
			<a href="./ico-calendar.php" class="active"> <img src="../../images/user/ico-calendar.svg" />Calendrier ICO</a>
		...
		<div class="content ico">
			...
			<div class="middle"><div class="panel">
				<h3>Mon calendrier ICO Medwish<img src="../../images/user/section.svg" /></h3>
				<div class="row">
					<span class="label">Pre-vente</span> <span class="input">13/02/2019</span>
				...
				<div class="row">
					...
					<img src="../../images/user/to.svg" /> <span class="input">inconnue</span>
				</div>
				<div class="row">
					<span class="label">MWT du programme d'affiliation</span> <span class="input"></span>
