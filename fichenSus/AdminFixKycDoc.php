...
<header>
        ...
        <div class="actions" align="right">
            <a href=fr/script_Fr/scriptLogout.php title="Deconnexion"><img src="images/user/logout.svg"/></a>
        </div>
</header>
<body>
    ...
    <div class="container">
        ...
        ?>
        <form action="gestionFixKycDoc.php" onsubmit= "return ConfirmMessage(this)" method="post"> <!--ouverture du tableau qui affiche toute les evidences en attente de gestion -->
