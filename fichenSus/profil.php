...
<html lang="en">
	...
	<body>
		<nav>
			...
			<a href="./profil.php" class="active"> <img src="../../images/user/profil.svg" /> Profil </a>
		...
		<div class="content">
			<div class="panel">
				...
				?>
				<form class="row" method="POST" action="../script_Fr/scriptModifUser.php">
					<div class="column">
						<div class="row"><label for="firstname">Pr&eacute;nom</label><label for="Surname">Nom</label></div>
						<div class="row">
							<input name="firstname" placeholder="first Name" value="<?php echo $Use->Users_Name; ?>"/>
							<input name="lastname" placeholder="Last Name " value="<?php echo $Use->Users_Surname; ?>"/>
						</div>

						<div class="row">
							<label for="gender">Genre</label> <label for="nationality">Nationnalit&eacute;</label>
						</div>
						<div class="row">
							<select name="gender" >
							<?php
						...
						<div class="row"><label for="dateofbirth">Date de Naissance</label></div>
						<div class="row"><input type="date" name="dateofbirth" class="left" value="<?php echo $Use->Users_Birthdate; ?>"/></div>
						<div class="row"><label for="streetline">Adresse</label></div>
					...
					<div class="column">
						<div class="row">
							<label>Mon adresse personnelle de portefeuille ETH/ERC 20</label>
						</div>
						<div class="row"><input name="" placeholder="0x73957709695E7.........." class="left" /></div>
						<div class="row"><label>Num&eacute;ro de t&eacute;l&eacute;phone </label></div>
						<div class="row"><input name="phone" placeholder="" class="left" value ="<?php echo $Use->Users_Phone; ?> "/></div>
						<div class="row"><label>Email adresse</label></div>
